...
{% block subject %}
Hola {{ nombre }}, Observación cuenta de cobro
{% endblock %}
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										Tu cuenta de cobro tiene una observación por parte del Analista financiero de la
                                        Asociación Nacional Para el Desarrollo Social - ANDES.
									</td>
								</tr>
                                <tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
													...
													<table border="0" cellpadding="0" cellspacing="0" width="100%">
														...
														<tr>
															<td style="padding: 25px 0 0 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
																<p>Ruta: <b> {{ ruta }} </b></p>
                                                                <p>Nombre: <b> {{ nombre_completo }} </b></p>
                                                                <p>Valor: <b> {{ valor }} </b></p>
															</td>
														</tr>
													</table>
                                ...
                                <tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										Cualquier inquietud puede ser consultada en la linea <b>6960219 - 6960220</b> en la
