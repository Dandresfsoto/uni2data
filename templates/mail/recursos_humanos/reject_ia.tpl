...
{% block subject %}
Hola {{ nombre }}, Te han rechazado tu informe de actividades
{% endblock %}
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										La seguridad social adjuntada para el pago de honorarios profesionales
                                        tiene una observación por parte del area de recurso humano.
                                        <br>
                                        Por favor ingrese a UNI2DATA y realice los cambios solicitados.
									</td>
								</tr>
                                <tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
