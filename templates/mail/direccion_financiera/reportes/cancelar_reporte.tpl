							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
										<b>Reinicio del reporte de pago: {{ nombre_reporte }}</b>
									</td>
								</tr>
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										Se notifica la cancelacion del reporte de pago con la siguiente información.
									</td>
								</tr>
								<tr>
									<td>
											...
											<tr>
												<td width="240" valign="top">
													<table border="0" cellpadding="0" cellspacing="0" width="100%">
														<tr>
															<td>
																<img src="{{ url_base }}/static/img/rejected.jpg" alt="" width="100%" height="240" style="display: block;" />
															</td>
														</tr>
													</table>
												</td>
													...
													<table border="0" cellpadding="0" cellspacing="0" width="100%">
														...
														<tr>
															<td style="padding: 25px 0 0 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                                                <p>Consecutivo: <b> {{ consecutivo }} </b></p>
                                                                <p>Valor: <b> {{ valor }} </b></p>
