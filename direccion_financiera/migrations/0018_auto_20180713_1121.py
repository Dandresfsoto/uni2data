# Generated by Django 2.0.1 on 2018-07-13 16:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('direccion_financiera', '0017_proyecto_cuenta'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reporte', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='direccion_financiera.Reportes')),
                ('tercero', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='recursos_humanos.Contratistas')),
                ('usuario_actualizacion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='usuario_actualizacion_prestamo', to=settings.AUTH_USER_MODEL)),
                ('usuario_creacion', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='usuario_creacion_prestamo', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
