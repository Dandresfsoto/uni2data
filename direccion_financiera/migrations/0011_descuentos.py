# Generated by Django 2.0.1 on 2018-04-02 16:59
...
def create_permissions(apps, schema_editor):
    ...
    Permission.objects.using(db_alias).bulk_create([
        ...
        Permission(name="Dirección financiera, ver descuentos", content_type=content_type, codename='direccion_financiera.descuentos.ver'),
        Permission(name="Dirección financiera, editar descuentos", content_type=content_type, codename='direccion_financiera.descuentos.editar'),
        Permission(name="Dirección financiera, crear descuentos", content_type=content_type, codename='direccion_financiera.descuentos.crear'),
        Permission(name="Dirección financiera, eliminar descuentos", content_type=content_type, codename='direccion_financiera.descuentos.eliminar'),
    ])

def create_groups(apps, schema_editor):

    #Consulta de descuentos
    consulta_descuentos, created = Group.objects.get_or_create(name = 'Dirección financiera, consulta descuentos')
    permisos_consulta_descuentos = Permission.objects.filter(codename__in = [
        'direccion_financiera.ver',
        'direccion_financiera.descuentos.ver'
    ])
    consulta_descuentos.permissions.add(*permisos_consulta_descuentos)

    #Edicion de descuentos
    edicion_descuentos, created = Group.objects.get_or_create(name='Dirección financiera, edición descuentos')
    permisos_edicion_descuentos = Permission.objects.filter(codename__in=[
        'direccion_financiera.ver',
        'direccion_financiera.descuentos.ver',
        'direccion_financiera.descuentos.crear',
        'direccion_financiera.descuentos.editar',
        'direccion_financiera.descuentos.eliminar'
    ])
    edicion_descuentos.permissions.add(*permisos_edicion_descuentos)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('direccion_financiera', '0010_pagos_publico'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pago', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='direccion_financiera.Pagos')),
                ('usuario_actualizacion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='descuentos_usuario_actualizacion_pago', to=settings.AUTH_USER_MODEL)),
                ('usuario_creacion', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='descuentos_usuario_creacion_pago', to=settings.AUTH_USER_MODEL)),
            ],
        ),
