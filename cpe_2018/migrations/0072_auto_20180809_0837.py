# Generated by Django 2.0.1 on 2018-08-09 13:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cpe_2018', '0071_cuentascobro_estado'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='cuentascobro',
            name='html',
            field=models.FileField(blank=True, null=True, upload_to=cpe_2018.models.upload_dinamic_cuentas_cobro),
        ),
        migrations.AddField(
            model_name='cuentascobro',
            name='valor',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='COP', max_digits=10),
        ),
        migrations.AddField(
            model_name='cuentascobro',
            name='valor_currency',
