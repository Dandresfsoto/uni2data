# Generated by Django 2.1.3 on 2018-12-20 14:39
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cpe_2018', '0117_entregablerutaobject_para_pago'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', config.extrafields.ContentTypeRestrictedFileField(blank=True, max_length=255, null=True, upload_to=cpe_2018.models.upload_dinamic_liquidaciones)),
                ('file2', config.extrafields.ContentTypeRestrictedFileField(blank=True, max_length=255, null=True, upload_to=cpe_2018.models.upload_dinamic_liquidaciones)),
                ('html', models.FileField(blank=True, null=True, upload_to=cpe_2018.models.upload_dinamic_liquidaciones)),
                ('delta', models.TextField(blank=True, null=True)),
                ('data_json', models.TextField(blank=True, null=True)),
                ('ruta', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cpe_2018.Rutas')),
            ],
        ),
        migrations.AddField(
            model_name='entregablerutaobject',
            name='liquidacion',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cpe_2018.Liquidaciones'),
        ),
    ]
