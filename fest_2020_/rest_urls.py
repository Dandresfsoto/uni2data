...
from fest_2020_ import rest_views
...
urlpatterns = [
    ...
    path('coordinacion/', rest_views.CoordinacionListApi.as_view()),
    path('coordinacion/reportes/<uuid:pk_ruta>/', rest_views.ReporteCoordinacionListApi.as_view()),
    ...
    #path('entes_territoriales_2020/', include('entes_territoriales_2020.rest_urls')),
    #path('formatos_2020/', include('formatos_2020.rest_urls')),

    path('liquidacion/', rest_views.LiquidacionListApi.as_view()),
